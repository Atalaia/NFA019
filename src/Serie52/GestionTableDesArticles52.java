...
public class GestionTableDesArticles52 implements MesInterfaces.InterfaceGestion<TableDesArticles52, TableDesCommandes>{
	...
	public void menuGeneral(TableDesArticles52 tabArt, TableDesCommandes tabCde) throws Abandon
	{
	...
	public void ajouter(TableDesArticles52 tabArt,TableDesCommandes obj) throws Abandon
	{
	...
	public void supprimer(TableDesArticles52 tabArt, TableDesCommandes tabCde) throws Abandon
	{
	...
	public void afficher(TableDesArticles52 tabArt)
	{
		if (tabArt.taille() == 0) ES.affiche("\n *** STOCK VIDE ! ***\n");
	...
	public ArticleAbstrait<Integer> saisie(TableDesArticles52 tabArt) throws Abandon
	{
		...
		if (tabArt.retourner(code)==null)
		{
			...
			return new Article52(code, designation, pu);
		}
		else {
