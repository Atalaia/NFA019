...
public class GestionUneCommande51 implements MesInterfaces.InterfaceGestion<TableDesLignesDeCommande, TableDesArticles51>{
		
	public void menuGeneral(TableDesLignesDeCommande cde, TableDesArticles51 tabArt) throws Abandon
	{
		int choix;
	...
	public void ajouter(TableDesLignesDeCommande cde, TableDesArticles51 tabArt) throws Abandon
	{
	...
	public void supprimer(TableDesLignesDeCommande cde, TableDesArticles51 obj) throws Abandon
	{
		int numeroLigne;
		afficher(cde);
	...
	public void facturer (TableDesArticles51 tabArt, TableDesLignesDeCommande cde)
	{
		if (cde.taille() == 0) ES.affiche("\n ***** COMMANDE VIDE!! **\n");
	...
	public LigneDeCommande saisie(TableDesArticles51 tabArt) throws Abandon
	{
		int code;
