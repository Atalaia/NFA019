...
public class GestionDesCommandes51 implements MesInterfaces.InterfaceGestion<TableDesCommandes, TableDesArticles51>
{
	...
	public void menuGeneral(TableDesCommandes tabCde, TableDesArticles51 tabArt) throws Abandon
	{
		int choix;
	...
	public void ajouter(TableDesCommandes tabCde, TableDesArticles51 tabArt) throws Abandon
	{
	...
	public void supprimer(TableDesCommandes tabCde, TableDesArticles51 obj) throws Abandon
	{
		if(tabCde.taille() !=0) {			
	...
	public void afficherUneCommande(TableDesCommandes tabCde) throws Abandon
	{
		if (tabCde.taille() != 0){
			...
			if(numCde == null){ClientS51.menuChoixGeneral();}
			if(tabCde.retourner(numCde) != null){
	...
	public void facturer1Commande(TableDesArticles51 tabArt, TableDesCommandes tabCde) throws Abandon
	{
	...
	// change, maintenant on cherche une clé
