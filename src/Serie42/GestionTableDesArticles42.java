...
//sustituer les article42 par articleabstrait et tabledesarticles41 par tabledesarticles42
public class GestionTableDesArticles42 implements MesInterfaces.InterfaceGestion<TableDesArticles42, TableDesCommandes>{
		
	public void menuGeneral(TableDesArticles42 tabArt, TableDesCommandes tabCde) throws Abandon
	{
	...
	public void ajouter(TableDesArticles42 tabArt,TableDesCommandes obj) throws Abandon
	{
	...
	public void supprimer(TableDesArticles42 tabArt, TableDesCommandes tabCde) throws Abandon
	{
	...
	public void afficher(TableDesArticles42 tabArt)
	{
		if (tabArt.taille() == 0) ES.affiche("\n *** STOCK VIDE ! ***\n");
