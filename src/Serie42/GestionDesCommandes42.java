...
//pareil tabledesarticles41 par tablesdesarticles42
public class GestionDesCommandes42 implements MesInterfaces.InterfaceGestion<TableDesCommandes, TableDesArticles42>
{
	
	public void menuGeneral(TableDesCommandes tabCde, TableDesArticles42 tabArt) throws Abandon
	{
		int choix;
	...
	public void ajouter(TableDesCommandes tabCde, TableDesArticles42 tabArt) throws Abandon
	{
	...
	public void supprimer(TableDesCommandes tabCde, TableDesArticles42 obj) throws Abandon
	{
		if(tabCde.taille() !=0) {			
	...
	public void facturer1Commande(TableDesArticles42 tabArt, TableDesCommandes tabCde) throws Abandon
	{
		ES.affiche(" \n** LISTE DES NUMEROS DE COMMANDES : \n" + tabCde.toString());
		int numero= ES.saisie("", 0, 999);
