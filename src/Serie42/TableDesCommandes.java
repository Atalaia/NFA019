...
public class TableDesCommandes implements MesInterfaces.InterfaceStructure<TableDesLignesDeCommande, Integer> {
	...
	public void supprimer(Integer numero) //numero de commande
	{
		if (retourner(numero) != null) tabCde.remove(numero);
	}
	
	public TableDesLignesDeCommande retourner(Integer numCde)
	{
