...
public class TableDesLignesDeCommande {
	...
	//facturer des tablesdeslignes de commande, appelle le facturer des lignes de commande, qui appelle le facturer d'article en fonction si c'est article normal ou article promo
